...
elseif Game == NenSim then
    loadstring(game:HttpGet("https://raw.githubusercontent.com/UsualCodeMan/Usual-hub/main/UsualHub/Nen-Fighting-Simulator.lua"))()
...
elseif Game == TappingLegendsX then
    loadstring(game:HttpGet("https://github.com/UsualCodeMan/Usual-hub/blob/main/UsualHub/Tapping-Legends-X.lua"))()
end
